...
with st.sidebar:
    ...
    choose = option_menu(
                        "Maria Diaz",
                        ["About Me", "Site Overview", "Experience", "Technical Skills", "Education", "Projects", "Conferences", "Volunteering", "Gallery", "Resume", "Testimonials", "Contact"],
...
#st.write("---")
    ...
    # Enlace para abrir el PDF en otra pestaña
    pdf_url = f"./{pdf_path}"
    st.markdown(f"[🔗 Open Resume in a new tab]({pdf_url})", unsafe_allow_html=True)
    ...
    with open(pdf_path, "rb") as file:
        st.download_button(
            ...
            data=file,
            file_name="MariaDiaz_Resume.pdf",
